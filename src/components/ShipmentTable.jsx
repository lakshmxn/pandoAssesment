        ...
        <tr key={row.id} onClick={() => handleRowClick(row)}>
          ...
          <td>
            <div style={{display: 'flex','justify-content': 'space-between'}}>
              <div className='row-item'>
                <div className='row-item-primary'>{row.origin?.city}</div>
                <div className='row-item-secondary'>{row.origin?.state}</div>
              </div>
              {!isSideTabOpen && 
          ...
          <td>
            <div className='row-item'>
              ...
              <div className='row-item-secondary'>{row.utilization?.vehicle}</div>
            </div>
          </td>
